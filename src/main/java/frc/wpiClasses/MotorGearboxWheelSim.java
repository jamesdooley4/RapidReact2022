...
class MotorGearboxWheelSim {
     ...
     *
     * @param motor_in
     *            Motor set used to provide power input.
     * @param gearRatio_in
     *            Gearbox Ratio. Gearboxes which slow down motors (ie all of them) should have this
     *            greater than 1.0.
     * @param wheelRadius_m_in
     *            Radius of the wheel in meters
     * @param gearboxFricCoef_NmPerRadPerSec_in
     *            Kinetic Friction Losses in the gearbox (expressed in units of Nm of "fighting" force
     *            per radian per second of motor speed). Set to 0 if you're awesome with white lithium
     *            grease, make it positive if your freshman maybe forget the grease sometimes.
     */
    public MotorGearboxWheelSim(DCMotor motor_in, double gearRatio_in, double wheelRadius_m_in,
    ...
    public void update(double groundVelocity_mps, double motorVoltage, double dtSeconds) {
        ...
        wheelRotations_rad += (wheelRotationalSpeed_radPerSec + prevWheelRotationalSpeed_radPerSec) / 2 * dtSeconds; // Trapezoidal
                                                                                                                        // integration
