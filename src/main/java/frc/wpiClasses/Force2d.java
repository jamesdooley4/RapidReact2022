...
public class Force2d {
     ...
     *
     * @param mag
     *            The magnititude of the force
     * @param angle
     *            The angle from the x-axis to the force vector.
     */
     ...
     *
     * <p>
     * This multiplies the force vector by a counterclockwise rotation
     * matrix of the given angle.
     * [x_new] [other.cos, -other.sin][x]
     * [y_new] = [other.sin, other.cos][y]
     *
     * <p>
     * For example, rotating a Force2d of {2, 0} by 90 degrees will return a
     * Force2d of {0, 2}.
     *
     * @param angle
     *            The rotation to rotate the force by.
     ...
     *
     * <p>
     * For example, Force2d{1.0, 2.5} + Force2d{2.0, 5.5} =
     * Force2d{3.0, 8.0}
     *
     * @param other
     *            The force to add.
     ...
     *
     * <p>
     * For example, Force2d{5.0, 4.0} - Force2d{1.0, 2.0} =
     * Force2d{4.0, 2.0}
     *
     * @param other
     *            The force to subtract.
