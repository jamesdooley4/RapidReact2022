...
public class SwerveModuleSim {
    ...
    Rotation2d cursteerAngle = Rotation2d.fromDegrees(0); // 0 = toward front, 90 = toward left, 180 = toward back, 270
                                                            // = toward right
    ...
    private static enum SteerValueType {
        VOLTAGE, ANGLE
    }
    ...
    public SwerveModuleSim(
            ...
            double azimuthEncGearRatio, // Encoder rotations per one azimuth module rotation. Should be 1.0 if you have
                                        // a good swerve module.
    ...
    public void setInputVoltages(double wheelVoltage, double steerVoltage) {
        ...
        this.steerValueType = SteerValueType.VOLTAGE;
    }

    public void setInputVoltageAndAngle(double wheelVoltage, double steerAngle) {
        this.wheelVoltage = wheelVoltage;
        this.steerAngle = steerAngle;
        this.steerValueType = SteerValueType.ANGLE;
    }
    ...
    void update(double dtSeconds) {
        ...
        if (steerValueType == SteerValueType.VOLTAGE) {
        ...
        } else if (steerValueType == SteerValueType.ANGLE) {
            cursteerAngle = Rotation2d.fromDegrees(this.steerAngle);
        }
